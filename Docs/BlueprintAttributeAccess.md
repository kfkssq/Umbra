...
6. AttackSpeed 直接填写攻速倍率：1.0 为基础速度，1.2 为120%，合法范围0.2～10.0。暴击率使用0.2=20%，暴击倍率2=两倍；恢复点/秒，移速厘米/秒，急速数值。
...
AttackSpeed 驱动玩家普通攻击逻辑周期与前摇，Montage 播放率另受表现上限约束；编辑或新建 Initial Attributes GE 时选择 `UmbraAttributeSet.AttackSpeed`，基础值为1.0。
